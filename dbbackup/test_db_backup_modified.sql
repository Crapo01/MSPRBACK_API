...
-- Started on 2025-06-26 09:17:36
...
ALTER TABLE public.pointers OWNER TO myuser;
...
ALTER TABLE public.pointers ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
COPY public.concerts (id, date, description, time, image, link, name, origin, scene) FROM stdin;
...
--
-- TOC entry 3395 (class 0 OID 16404)
-- Dependencies: 217
-- Data for Name: infos; Type: TABLE DATA; Schema: public; Owner: myuser
--

COPY public.infos (id, priority, message) FROM stdin;
...
COPY public.pointers (id, description, lat, link, lon, name, type) FROM stdin;
...
--
-- TOC entry 3401 (class 0 OID 16419)
-- Dependencies: 223
...
1	superuser@site.com	$2a$10$QqtAds2wFxsmE.NJh5m.SeU5YdVC/hS.88hpOqtD/QWJfXiyRVa2S	superuser
36	string@site.com	$2a$10$njuPMeUn8CSRlbVjmtMRQu3.Z.LNfK6NJtBlAXrq4.0tSI6vsrOfS	string
40	example@site.com	$2a$10$FtBqZApCzWvFZlB9uI7XiOIj6x7vAN2uvL6U/NWqOwyu5Mj7qyhem	editor
\.
...
SELECT pg_catalog.setval('public.infos_id_seq', 27, true);
...
SELECT pg_catalog.setval('public.pointeurs_id_seq', 12, true);
...
--
-- TOC entry 3233 (class 2606 OID 16427)
...
--
-- TOC entry 3235 (class 2606 OID 16429)
...
--
-- TOC entry 3237 (class 2606 OID 16431)
...
--
-- TOC entry 3243 (class 2606 OID 16435)
...
--
-- TOC entry 3241 (class 2606 OID 16439)
...
-- Completed on 2025-06-26 09:17:51
